...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log('age from', this.$refs.ageInput.value)
      console.log(31)
      this.userAge = null;
      this.referrer = 'wom'
      console.log(`file: TheForm.vue • line 76 • this.interest`, this.interest)
      console.log(`file: TheForm.vue • line 76 • this.how`, this.how)
      this.interest = [];
      this.how = null;
    ...
    validateInput(){
      if (this.userName.length > 0) this.userNameValidity = 'valid'
      else this.userNameValidity = 'invalid'
    }
  }
}
</script>
